...
public class MainMyTreeMap {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n");
		System.out.println("##################################################\t SET PREFIXE \t##################################################\n");
		System.out.println(mhm.keySetPrefixe());
		System.out.println("\n");
		System.out.println("##################################################\t NOMBRE DE FEUILLES \t##################################################\n");		
